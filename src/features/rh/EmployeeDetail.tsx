...
export const EmployeeDetail: React.FC = () => {
  ...
  const contractStyle = getContractBadge(employee.contractType);
        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', gap: 12, paddingBottom: 12 }}>
              <Button variant="primary" onClick={() => navigate(`/rh/employees?edit=${employee.id}`)}>
                ✎ Modifier
              </Button>
              <Button 
                variant="secondary" 
      ...
      {activeTab === 'conges' && (
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
            ...
            <Button variant="primary" onClick={() => navigate('/rh/leaves')}>
              + Demander un congé
            </Button>
          </div>
      ...
      {activeTab === 'performance' && (
        <div>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
            ...
            <Button variant="primary" onClick={() => navigate('/rh/performance')}>
              + Nouvelle évaluation
            </Button>
          </div>
